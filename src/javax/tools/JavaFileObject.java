...
public interface JavaFileObject extends FileObject {
     ...
     * A simple name is a single identifier (not qualified) as defined in
     * The Java Language Specification section 6.2 "Names and Identifiers".
     *
     ...
     * This method may return {@link NestingKind#MEMBER} to mean {@link NestingKind#LOCAL} or {@link NestingKind#ANONYMOUS}.
    ...
    /*
     * 提供有关此文件对象所表示的类的嵌套类型
     * 如果嵌套类型未知或此文件对象不表示类文件，则此方法返回null
     */
    NestingKind getNestingKind();
    
    /**
     * Provides a hint about the access level of the class represented by this file object.
     * If the access level is not known or if this file object does not represent a class file this method returns {@code null}.
     *
     * @return the access level
     */
    /*
     * 提供有关此文件对象所表示的类的访问级别的提示
     * 如果访问级别未知或此文件对象不表示类文件，则此方法返回null
     */
