 ...
 */
/*
 * UUID的意思是：通用唯一识别码。该类用于生成唯一的标识
 *
 * 更多生成方式参见：https://mvnrepository.com/artifact/com.fasterxml.uuid/java-uuid-generator
 */
public final class UUID implements java.io.Serializable, Comparable<UUID> {
     ...
     *
     * The {@code UUID} is generated using a cryptographically strong pseudo m number generator.
     *
     ...
     */
    // 生成第3类UUID，参见version()。（name一致时，UUID也一致）
     ...
     * The version number describes how this {@code UUID} was generated.
     *
     ...
     * The variant number describes the layout of the {@code UUID}.
     *
    ...
    public int compareTo(UUID val) {
        ...
        return (this.mostSigBits<val.mostSigBits
            ? -1 : (this.mostSigBits>val.mostSigBits
                     ? 1 : (this.leastSigBits<val.leastSigBits
                             ? -1 : (this.leastSigBits>val.leastSigBits ? 1 : 0))));
    }
