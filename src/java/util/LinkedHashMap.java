...
public class LinkedHashMap<K, V> extends HashMap<K, V> implements Map<K, V> {
     ...
     * specified value
     */
    // 判断LinkedHashMap中是否存在指定value的元素
    ...
    // LinkedHashMap中key-value的集合，Entry的本质就是Node
