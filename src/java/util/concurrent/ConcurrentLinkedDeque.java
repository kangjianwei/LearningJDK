...
restartFromTail:
    ...
    private final void updateHead() {
        // Either head already points to an active node,
        // or we keep trying to cas it to the first node until it does.
        Node<E> h, p, q;
restartFromHead:
    ...
    private final void updateTail() {
        // Either tail already points to an active node,
        // or we keep trying to cas it to the last node until it does.
        Node<E> t, p, q;
restartFromTail:
