...
class VersionProps {
    ...
    private static final String java_version_date = "2018-09-25";
    
    private static final String java_runtime_name = "OpenJDK Runtime Environment";
    
    private static final String java_runtime_version = "11+28";
    
    private static final String VERSION_NUMBER = "11";
    
    private static final String VERSION_BUILD = "28";
    ...
    private static final String VENDOR_VERSION_STRING = "18.9";
    
    private static final String vendor_version = (VENDOR_VERSION_STRING.length()>0 ? " " + VENDOR_VERSION_STRING : "");
    ...
    /**
     * This is the same as print except that it adds an extra line-feed at the end,
     * typically used by the -showversion in the launcher
     */
    // 打印版本信息
    ...
    private static void print(boolean err, boolean newln) {
        ...
        if(err) {
            ps.println(launcher_name + " version \"" + java_version + "\"" + " " + java_version_date + (isLTS ? " LTS" : ""));
        } else {
            /* Use a format more in line with GNU conventions */
            ps.println(launcher_name + " " + java_version + " " + java_version_date + (isLTS ? " LTS" : ""));
        }
