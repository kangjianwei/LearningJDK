...
final class SystemModules$all implements SystemModules {
    ...
    public ModuleDescriptor[] moduleDescriptors() {
        ...
        var37.packages(var2);
        var37.version("11.0.1");
        var1[52] = var37.build(-569312359);
        var37 = new Builder("jdk.jshell");
        var37.requires(new Requires[]{Builder.newRequires(var17, "java.compiler"), Builder.newRequires(var16, "jdk.compiler"), Builder.newRequires(var14, "java.base"), Builder.newRequires(var16, "jdk.internal.ed"), Builder.newRequires(var16, "java.logging"), Builder.newRequires(var16, "jdk.internal.opt"), Builder.newRequires(var17, "jdk.jdi"), Builder.newRequires(var16, "jdk.internal.le"), Builder.newRequires(var17, "java.prefs")});
        var37.exports(new Exports[]{Builder.newExports(var4, "jdk.jshell.spi"), Builder.newExports(var4, "jdk.jshell.tool"), Builder.newExports(var4, "jdk.jshell"), Builder.newExports(var4, "jdk.jshell.execution")});
        var37.opens(new Opens[0]);
        var2 = Set.of("jdk.internal.editor.spi.BuildInEditorProvider", "jdk.jshell.spi.ExecutionControlProvider");
        var37.uses(var2);
        var37.provides(new Provides[]{Builder.newProvides("javax.tools.Tool", List.of("jdk.internal.jshell.tool.JShellToolProvider")), Builder.newProvides("jdk.jshell.spi.ExecutionControlProvider", List.of("jdk.jshell.execution.JdiExecutionControlProvider", "jdk.jshell.execution.LocalExecutionControlProvider", "jdk.jshell.execution.FailOverExecutionControlProvider"))});
        ...
        var37.packages(var2);
        var37.version("11.0.1");
        var1[53] = var37.build(1485078955);
        var37 = new Builder("jdk.jsobject");
        var37.requires(new Requires[]{Builder.newRequires(var14, "java.base"), Builder.newRequires(var16, "java.desktop")});
        var37.exports(new Exports[]{Builder.newExports(var4, "netscape.javascript")});
        var37.opens(new Opens[0]);
        ...
        var37.packages(var2);
        var37.version("11.0.1");
        var1[54] = var37.build(-1673839156);
        var37 = new Builder("jdk.jstatd");
        var37.requires(new Requires[]{Builder.newRequires(var16, "jdk.internal.jvmstat"), Builder.newRequires(var14, "java.base"), Builder.newRequires(var16, "java.rmi")});
        var37.exports(new Exports[]{Builder.newExports(var4, "sun.jvmstat.monitor.remote", var35)});
        var37.opens(new Opens[0]);
        var37.uses(var22);
        var37.provides(new Provides[]{Builder.newProvides("sun.jvmstat.monitor.MonitoredHostService", List.of("sun.jvmstat.perfdata.monitor.protocol.rmi.MonitoredHostRmiService"))});
        var2 = Set.of("sun.jvmstat.perfdata.monitor.protocol.rmi", "sun.jvmstat.monitor.remote", "sun.tools.jstatd");
        var37.packages(var2);
        var37.version("11.0.1");
        var1[55] = var37.build(872214599);
        var37 = new Builder("jdk.localedata");
        var37.requires(new Requires[]{Builder.newRequires(var14, "java.base")});
        var37.exports(new Exports[0]);
        var37.opens(new Opens[0]);
        var37.uses(var22);
        var37.provides(new Provides[]{Builder.newProvides("sun.util.resources.LocaleData$CommonResourceBundleProvider", List.of("sun.util.resources.provider.LocaleDataProvider")), Builder.newProvides("sun.util.locale.provider.LocaleDataMetaInfo", List.of("sun.util.resources.cldr.provider.CLDRLocaleDataMetaInfo", "sun.util.resources.provider.NonBaseLocaleDataMetaInfo")), Builder.newProvides("sun.util.resources.LocaleData$SupplementaryResourceBundleProvider", List.of("sun.util.resources.provider.SupplementaryLocaleDataProvider"))});
        ...
        var37.packages(var2);
        var37.version("11.0.1");
        var1[56] = var37.build(-477112092);
        var37 = new Builder("jdk.management.jfr");
        var37.requires(new Requires[]{Builder.newRequires(var14, "java.base"), Builder.newRequires(var16, "jdk.management"), Builder.newRequires(var16, "jdk.jfr"), Builder.newRequires(var17, "java.management")});
        var37.exports(new Exports[]{Builder.newExports(var4, "jdk.management.jfr")});
        var37.opens(new Opens[0]);
        var37.uses(var22);
        var37.provides(new Provides[]{Builder.newProvides("sun.management.spi.PlatformMBeanProvider", List.of("jdk.management.jfr.internal.FlightRecorderMXBeanProvider"))});
        var2 = Set.of("jdk.management.jfr", "jdk.management.jfr.internal");
        var37.packages(var2);
        var37.version("11.0.1");
        var1[57] = var37.build(-827653401);
        var37 = new Builder("jdk.naming.dns");
        var37.requires(new Requires[]{Builder.newRequires(var14, "java.base"), Builder.newRequires(var16, "java.naming")});
        var37.exports(new Exports[]{Builder.newExports(var4, "com.sun.jndi.url.dns", var13)});
        var37.opens(new Opens[0]);
        var37.uses(var22);
        var37.provides(new Provides[]{Builder.newProvides("javax.naming.spi.InitialContextFactory", List.of("com.sun.jndi.dns.DnsContextFactory"))});
        var2 = Set.of("com.sun.jndi.url.dns", "com.sun.jndi.dns");
        var37.packages(var2);
        var37.version("11.0.1");
        var1[58] = var37.build(1758428188);
        var37 = new Builder("jdk.naming.rmi");
        var37.requires(new Requires[]{Builder.newRequires(var14, "java.base"), Builder.newRequires(var16, "java.rmi"), Builder.newRequires(var16, "java.naming")});
        var37.exports(new Exports[]{Builder.newExports(var4, "com.sun.jndi.rmi.registry", var35), Builder.newExports(var4, "com.sun.jndi.url.rmi", var13)});
        var37.opens(new Opens[0]);
        var37.uses(var22);
        var37.provides(new Provides[]{Builder.newProvides("javax.naming.spi.InitialContextFactory", List.of("com.sun.jndi.rmi.registry.RegistryContextFactory"))});
        var2 = Set.of("com.sun.jndi.rmi.registry", "com.sun.jndi.url.rmi");
        var37.packages(var2);
        var37.version("11.0.1");
        var1[59] = var37.build(-1355938378);
        var37 = new Builder("jdk.net");
        var37.requires(new Requires[]{Builder.newRequires(var14, "java.base")});
        var37.exports(new Exports[]{Builder.newExports(var4, "jdk.nio"), Builder.newExports(var4, "jdk.net")});
        var37.opens(new Opens[0]);
        var37.uses(var22);
        var37.provides(new Provides[0]);
        ...
        var37.packages(var2);
        var37.version("11.0.1");
        var1[60] = var37.build(-2839346);
        var37 = new Builder("jdk.pack");
        var37.requires(new Requires[]{Builder.newRequires(var14, "java.base")});
        var37.exports(new Exports[0]);
        var37.opens(new Opens[0]);
        var37.uses(var22);
        ...
        var37.packages(var2);
        var37.version("11.0.1");
        var1[61] = var37.build(-297964118);
        var37 = new Builder("jdk.rmic");
        var37.requires(new Requires[]{Builder.newRequires(var16, "jdk.javadoc"), Builder.newRequires(var16, "jdk.compiler"), Builder.newRequires(var14, "java.base")});
        var37.exports(new Exports[0]);
        var37.opens(new Opens[0]);
        var37.uses(var22);
        var37.provides(new Provides[0]);
        var2 = Set.of("sun.tools.tree", "sun.rmi.rmic", "sun.tools.util", "sun.tools.asm", "sun.tools.javac", "sun.rmi.rmic.resources", "sun.tools.javac.resources", "sun.tools.java");
        var37.packages(var2);
        var37.version("11.0.1");
        var1[62] = var37.build(107749054);
        var37 = new Builder("jdk.scripting.nashorn");
        var37.requires(new Requires[]{Builder.newRequires(var16, "jdk.dynalink"), Builder.newRequires(var14, "java.base"), Builder.newRequires(var17, "java.scripting"), Builder.newRequires(var16, "java.logging")});
        Exports[] var10318 = new Exports[5];
        Set var36 = Set.of("jdk.scripting.nashorn.shell");
        var10318[0] = Builder.newExports(var4, "jdk.nashorn.tools", var36);
        var10318[1] = Builder.newExports(var4, "jdk.nashorn.api.scripting");
        var10318[2] = Builder.newExports(var4, "jdk.nashorn.internal.objects", var36);
        var10318[3] = Builder.newExports(var4, "jdk.nashorn.internal.runtime", var36);
        var10318[4] = Builder.newExports(var4, "jdk.nashorn.api.tree");
        var37.exports(var10318);
        var37.opens(new Opens[0]);
        var37.uses(var22);
        var37.provides(new Provides[]{Builder.newProvides("javax.script.ScriptEngineFactory", List.of("jdk.nashorn.api.scripting.NashornScriptEngineFactory")), Builder.newProvides("jdk.dynalink.linker.GuardingDynamicLinkerExporter", List.of("jdk.nashorn.api.linker.NashornLinkerExporter"))});
        ...
        var37.packages(var2);
        var37.version("11.0.1");
        var1[63] = var37.build(-119658488);
        var37 = new Builder("jdk.scripting.nashorn.shell");
        Requires[] var10322 = new Requires[5];
        Set var3 = Set.of(Modifier.STATIC);
        var10322[0] = Builder.newRequires(var3, "java.compiler");
        var10322[1] = Builder.newRequires(var14, "java.base");
        var10322[2] = Builder.newRequires(var16, "jdk.internal.ed");
        var10322[3] = Builder.newRequires(var16, "jdk.scripting.nashorn");
        var10322[4] = Builder.newRequires(var16, "jdk.internal.le");
        var37.requires(var10322);
        var37.exports(new Exports[0]);
        var37.opens(new Opens[0]);
        var2 = Set.of("jdk.internal.editor.spi.BuildInEditorProvider");
        var37.uses(var2);
        var37.provides(new Provides[0]);
        var2 = Set.of("jdk.nashorn.tools.jjs", "jdk.nashorn.tools.jjs.resources");
        var37.packages(var2);
        var37.version("11.0.1");
        var1[64] = var37.build(1489718642);
        var37 = new Builder("jdk.sctp");
        var37.requires(new Requires[]{Builder.newRequires(var14, "java.base")});
        var37.exports(new Exports[]{Builder.newExports(var4, "com.sun.nio.sctp")});
        var37.opens(new Opens[0]);
        var37.uses(var22);
        var37.provides(new Provides[0]);
        ...
        var37.packages(var2);
        var37.version("11.0.1");
        var1[65] = var37.build(-1837191506);
        var37 = new Builder("jdk.security.auth");
        var37.requires(new Requires[]{Builder.newRequires(var17, "java.naming"), Builder.newRequires(var16, "java.security.jgss"), Builder.newRequires(var14, "java.base")});
        var37.exports(new Exports[]{Builder.newExports(var4, "com.sun.security.auth.callback"), Builder.newExports(var4, "com.sun.security.auth.login"), Builder.newExports(var4, "com.sun.security.auth"), Builder.newExports(var4, "com.sun.security.auth.module")});
        var37.opens(new Opens[0]);
        var37.uses(var22);
        var37.provides(new Provides[]{Builder.newProvides("javax.security.auth.spi.LoginModule", List.of("com.sun.security.auth.module.Krb5LoginModule", "com.sun.security.auth.module.UnixLoginModule", "com.sun.security.auth.module.JndiLoginModule", "com.sun.security.auth.module.KeyStoreLoginModule", "com.sun.security.auth.module.LdapLoginModule", "com.sun.security.auth.module.NTLoginModule"))});
        ...
        var37.packages(var2);
        var37.version("11.0.1");
        var1[66] = var37.build(1726597976);
        var37 = new Builder("jdk.security.jgss");
        var37.requires(new Requires[]{Builder.newRequires(var14, "java.base"), Builder.newRequires(var16, "java.logging"), Builder.newRequires(var17, "java.security.jgss"), Builder.newRequires(var16, "java.security.sasl")});
        var37.exports(new Exports[]{Builder.newExports(var4, "com.sun.security.jgss")});
        var37.opens(new Opens[0]);
        var37.uses(var22);
        var37.provides(new Provides[]{Builder.newProvides("java.security.Provider", List.of("com.sun.security.sasl.gsskerb.JdkSASL"))});
        var2 = Set.of("com.sun.security.sasl.gsskerb", "com.sun.security.jgss");
        var37.packages(var2);
        var37.version("11.0.1");
        var1[67] = var37.build(2045430005);
        var37 = new Builder("jdk.unsupported.desktop");
        var37.requires(new Requires[]{Builder.newRequires(var14, "java.base"), Builder.newRequires(var17, "java.desktop")});
        var37.exports(new Exports[]{Builder.newExports(var4, "jdk.swing.interop")});
        var37.opens(new Opens[0]);
        var37.uses(var22);
        var37.provides(new Provides[]{Builder.newProvides("sun.swing.InteropProvider", List.of("jdk.swing.interop.internal.InteropProviderImpl"))});
        var2 = Set.of("jdk.swing.interop", "jdk.swing.interop.internal");
        var37.packages(var2);
        var37.version("11.0.1");
        var1[68] = var37.build(-940969549);
        var37 = new Builder("jdk.xml.dom");
        var37.requires(new Requires[]{Builder.newRequires(var17, "java.xml"), Builder.newRequires(var14, "java.base")});
        var37.exports(new Exports[]{Builder.newExports(var4, "org.w3c.dom.html"), Builder.newExports(var4, "org.w3c.dom.xpath"), Builder.newExports(var4, "org.w3c.dom.css"), Builder.newExports(var4, "org.w3c.dom.stylesheets")});
        var37.opens(new Opens[0]);
        var37.uses(var22);
        var37.provides(new Provides[0]);
        ...
        var37.packages(var2);
        var37.version("11.0.1");
        var1[69] = var37.build(857969997);
        var37 = new Builder("jdk.zipfs");
        var37.requires(new Requires[]{Builder.newRequires(var14, "java.base")});
        var37.exports(new Exports[0]);
        var37.opens(new Opens[0]);
        var37.uses(var22);
        var37.provides(new Provides[]{Builder.newProvides("java.nio.file.spi.FileSystemProvider", List.of("jdk.nio.zipfs.ZipFileSystemProvider"))});
        var2 = Set.of("jdk.nio.zipfs");
        var37.packages(var2);
        var37.version("11.0.1");
        var1[70] = var37.build(381254363);
        return var1;
    }
    
    public ModuleTarget[] moduleTargets() {
        ModuleTarget[] var1 = new ModuleTarget[71];
        var1[0] = new ModuleTarget("windows-amd64");
        return var1;
    }
    
    public ModuleHashes[] moduleHashes() {
        ModuleHashes[] var1 = new ModuleHashes[71];
    ...
    public ModuleResolution[] moduleResolutions() {
        ModuleResolution[] var1 = new ModuleResolution[71];
        return var1;
    }
    
    public Map moduleReads() {
        Set var1 = Set.of("jdk.internal.vm.compiler", "jdk.management", "java.management", "jdk.internal.vm.ci", "java.base");
        Set var2 = Set.of("java.naming", "java.base");
        Set var3 = Set.of("java.logging", "java.base");
        Set var4 = Set.of("java.base");
        Set var5 = Set.of("java.xml", "java.base");
        Set var6 = Set.of("java.desktop", "java.xml", "java.datatransfer", "java.base");
        return Map.ofEntries(Map.entry("jdk.management.jfr", Set.of("jdk.management", "java.management", "jdk.jfr", "java.base")), Map.entry("java.rmi", var3), Map.entry("jdk.jdi", Set.of("jdk.jdwp.agent", "jdk.attach", "java.base")), Map.entry("jdk.charsets", var4), Map.entry("jdk.pack", var4), Map.entry("java.xml", var4), Map.entry("jdk.xml.dom", var5), Map.entry("jdk.rmic", Set.of("jdk.javadoc", "java.compiler", "jdk.compiler", "java.base")), Map.entry("java.datatransfer", var4), Map.entry("jdk.jstatd", Set.of("java.rmi", "jdk.internal.jvmstat", "java.base")), Map.entry("jdk.httpserver", var4), Map.entry("jdk.jcmd", Set.of("jdk.attach", "jdk.internal.jvmstat", "java.base")), Map.entry("java.desktop", Set.of("java.prefs", "java.xml", "java.datatransfer", "java.base")), Map.entry("java.se", Set.of("java.rmi", "java.sql", "java.transaction.xa", "java.xml.crypto", "java.logging", "java.sql.rowset", "java.xml", "java.management", "java.datatransfer", "java.instrument",
         "java.security" + ".jgss", "java.desktop", "java.naming", "java.compiler", "java.scripting", "java.prefs", "java.net.http", "java.security.sasl", "java.management.rmi", "java.base")), Map.entry("java.security.sasl", var3), Map.entry("jdk.zipfs", var4), Map.entry("java.base", Set.of()), Map.entry("jdk.crypto.ec", var4), Map.entry("jdk.javadoc", Set.of("java.compiler", "java.xml", "jdk.compiler", "java.base")), Map.entry("jdk.management.agent", Set.of("java.rmi", "java.management", "java.management.rmi", "java.base")), Map.entry("jdk.jshell", Set.of("jdk.jdi", "java.compiler", "jdk.internal.ed", "java.prefs", "java.logging", "jdk.internal.le", "jdk.compiler", "jdk.internal.opt", "java.base")), Map.entry("jdk.editpad", Set.of("java.desktop", "jdk.internal.ed", "java.xml", "java.datatransfer", "java.base")), Map.entry("jdk.jsobject", var6), Map.entry("java.sql.rowset", Set.of("java.sql", "java.naming", "java.transaction.xa", "java.logging", "java.xml", "java.base")), Map.entry(
             "jdk.sctp", var4), Map.entry("jdk.jlink", Set.of("jdk.jdeps", "jdk.internal.opt", "java.base")), Map.entry("java.smartcardio", var4), Map.entry("jdk.unsupported", var4), Map.entry("jdk.scripting.nashorn", Set.of("java.scripting", "jdk.dynalink", "java.logging", "java.base")), Map.entry("jdk.scripting.nashorn.shell", Set.of("java.compiler", "java.scripting", "jdk.internal.ed", "jdk.internal.le", "jdk.scripting.nashorn", "java.base")), Map.entry("java.security.jgss", var2), Map.entry("java.compiler", var4), Map.entry("jdk.dynalink", var3), Map.entry("jdk.unsupported.desktop", var6), Map.entry("jdk.accessibility", var6), Map.entry("jdk.security.jgss", Set.of("java.security.jgss", "java.logging", "java.security.sasl", "java.base")), Map.entry("java.sql", Set.of("java.transaction.xa", "java.logging", "java.xml", "java.base")), Map.entry("jdk.hotspot.agent", Set.of("java.rmi", "java.desktop", "java.scripting", "java.xml", "java.datatransfer", "java.base")),
              Map.entry("java" + ".xml.crypto", Set.of("java.logging", "java.xml", "java.base")), Map.entry("java.logging", var4), Map.entry("java.transaction.xa", var4), Map.entry("jdk.jfr", var4), Map.entry("jdk.internal.vm.ci", var4), Map.entry("jdk.crypto.cryptoki", Set.of("java.base", "jdk.crypto.ec")), Map.entry("jdk.net", var4), Map.entry("java.naming", Set.of("java.security.sasl", "java.base")), Map.entry("jdk.internal.ed", var4), Map.entry("java.prefs", var5), Map.entry("java.net.http", var4), Map.entry("jdk.compiler", Set.of("java.compiler", "java.base")), Map.entry("jdk.naming.rmi", Set.of("java.rmi", "java.naming", "java.base")), Map.entry("jdk.internal.opt", var4), Map.entry("jdk.jconsole", Set.of("java.rmi", "jdk.management", "jdk.management.agent", "java.desktop", "java.management", "java.xml", "jdk.attach", "java.datatransfer", "jdk.internal.jvmstat", "java.management.rmi", "java.base")), Map.entry("jdk.attach", Set.of("jdk.internal.jvmstat", "java.base")),
               Map.entry("jdk.crypto" + ".mscapi", var4), Map.entry("jdk.internal.le", var4), Map.entry("java.management", var4), Map.entry("jdk.jdwp.agent", var4), Map.entry("jdk.internal.jvmstat", var4), Map.entry("java.instrument", var4), Map.entry("jdk.internal.vm.compiler", Set.of("jdk.management", "java.management", "jdk.unsupported", "jdk.internal.vm.ci", "java.base", "java.instrument")), Map.entry("jdk.internal.vm.compiler.management", var1), Map.entry("jdk.management", Set.of("java.management", "java.base")), Map.entry("jdk.security.auth", Set.of("java.security.jgss", "java.naming", "java.base")), Map.entry("java.scripting", var4), Map.entry("jdk.jdeps", Set.of("java.compiler", "jdk.compiler", "java.base")), Map.entry("jdk.aot", var1), Map.entry("jdk.jartool", var4), Map.entry("java.management.rmi", Set.of("java.rmi", "java.naming", "java.management", "java.base")), Map.entry("jdk.naming.dns", var2), Map.entry("jdk.localedata", var4));
    }
    ...
    public Map concealedPackagesToOpen() {
        ...
        ".implementations")), Map.entry("java.xml", Set.of("com.sun.org.apache.xml.internal.dtm.ref.sax2dtm", "com.sun.org.apache.bcel.internal.generic", "com.sun.org.apache.xalan.internal.lib", "com.sun.org.apache.xalan.internal.xsltc.trax", "com.sun.org.apache.xerces.internal.impl.dv", "com.sun.xml.internal.stream.writers", "com.sun.org.apache.xerces.internal.xs.datatypes", "com.sun.org.apache.xerces.internal.impl.validation", "com.sun.org.apache.xerces.internal.impl.xs.util", "com.sun.org.apache.xerces.internal.jaxp.validation", "com.sun.org.apache.xpath.internal.compiler", "com.sun.org.apache.xpath.internal.functions", "com.sun.org.apache.xml.internal.dtm.ref.dom2dtm", "com.sun.org.apache.xalan.internal", "com.sun.org.apache.xerces.internal.xni.grammars", "com.sun.org.apache.xml.internal.utils", "com.sun.org.apache.xerces.internal.impl.io", "com.sun.org.apache.xerces.internal.impl", "com.sun.org.apache.xerces.internal.impl.xpath",
         ...
         ".sun.org.apache.xerces.internal.impl.xs.opti", "com.sun" + ".org.apache.xerces.internal.jaxp.datatype", "com.sun.org.apache.xerces.internal.xinclude", "com.sun.org.apache.xalan.internal.res", "com.sun.org.apache.bcel.internal.util", "com.sun.org.apache.xalan.internal.xsltc.compiler", "com.sun.org.apache.xerces.internal.dom.events", "com.sun.org.apache.xml.internal.serializer.utils", "com.sun.org.apache.xml.internal.dtm", "com.sun.org.apache.xalan.internal.xsltc.compiler.util", "com.sun.org.apache.xerces.internal.impl.xs.models", "com.sun.org.apache.xerces.internal.xs", "com.sun.org.apache.bcel.internal", "com.sun.org.apache.xerces.internal.impl.dtd", "com.sun.org.apache.xerces.internal.util")), Map.entry("jdk.jfr", Set.of("jdk.jfr.events")), Map.entry("jdk.rmic", Set.of("sun.tools.tree", "sun.rmi.rmic", "sun.tools.util", "sun.tools.asm", "sun.tools.javac", "sun.tools.java")), Map.entry("jdk.jstatd", Set.of("sun.jvmstat.perfdata.monitor.protocol.rmi",
          "sun.jvmstat.monitor" + ".remote", "sun.tools.jstatd")), Map.entry("jdk.httpserver", Set.of("sun.net.httpserver")), Map.entry("jdk.jcmd", Set.of("sun.tools.jstack", "sun.tools.jstat", "sun.tools.jmap", "sun.tools.jps", "sun.tools.jcmd", "sun.tools.jinfo")), Map.entry("jdk.crypto.cryptoki", Set.of("sun.security.pkcs11.wrapper", "sun.security.pkcs11")), Map.entry("java.naming", Set.of("com.sun.jndi.ldap.sasl", "com.sun.jndi.url.ldap", "sun.security.provider.certpath.ldap", "com.sun.jndi.ldap", "com.sun.jndi.toolkit.url", "com.sun.naming.internal", "com.sun.jndi.ldap.pool", "com.sun.jndi.toolkit.dir", "com.sun.jndi.ldap.ext", "com.sun.jndi.toolkit.ctx", "com.sun.jndi.url.ldaps")), Map.entry("java.desktop", Set.of("com.sun.beans.decoder", "com.sun.java.swing.plaf.windows.resources", "com.sun.imageio.plugins.bmp", "com.sun.java.swing.plaf.windows", "com.sun.swing.internal.plaf.metal.resources", "com.sun.beans", "com.sun.imageio.plugins.wbmp", "sun.awt.image", "sun.awt.geom",
          "sun.java2d", "com.sun" + ".beans.finder", "sun.awt.windows", "sun.swing.table", "java" + ".awt.dnd.peer", "sun.awt.event", "sun.swing.plaf.synth", "sun.swing.plaf.windows", "java.awt.peer", "sun.java2d.pipe", "sun.java2d.pipe.hw", "sun.java2d.d3d", "sun.awt.datatransfer", "sun.java2d.windows", "sun.swing.icon", "com.sun.java.swing.plaf.motif.resources", "com.sun.imageio.plugins.gif", "com.sun.imageio.spi", "com.sun.java.swing", "com.sun.beans.util", "com.sun.swing.internal.plaf.basic.resources", "sun.awt.im", "sun.print.resources", "sun.java2d.cmm.lcms", "sun.awt.util", "sun.awt", "sun.java2d.loops", "com.sun.imageio.plugins.common", "sun.awt.resources", "com.sun.accessibility.internal.resources", "sun.awt.shell", "com.sun.imageio.plugins.jpeg", "com.sun.swing.internal.plaf.synth.resources", "sun.java2d.cmm", "com.sun.awt", "com.sun.imageio.plugins.png", "sun.applet", "sun.swing.plaf", "sun.swing.text.html", "com.sun.imageio.stream", "sun.swing.text", "sun.awt.dnd",
           "sun" + ".java2d.opengl", "sun" + ".print", "com.sun.beans.infos", "sun.font", "sun.swing", "com.sun" + ".beans.editors", "com.sun.java.swing.plaf.motif", "com.sun.media.sound")), Map.entry("jdk.compiler", Set.of("com.sun.tools.javac.tree", "com.sun.tools.javac.main", "com.sun.tools.javac.parser", "com.sun.tools.javac.processing", "com.sun.tools.javac.file", "com.sun.tools.javac.api", "com.sun.tools.doclint", "com.sun.tools.doclint.resources", "com.sun.tools.javac.jvm", "com.sun.tools.javac.model", "com.sun.tools.javac.comp", "com.sun.tools.javac.code", "com.sun.tools.javac.resources", "sun.tools.serialver", "com.sun.tools.javac.util")), Map.entry("java.security.sasl", Set.of("com.sun.security.sasl.ntlm", "com.sun.security.sasl", "com.sun.security.sasl.util", "com.sun.security.sasl.digest")), Map.entry("jdk.naming.rmi", Set.of("com.sun.jndi.rmi.registry", "com.sun.jndi.url.rmi")), Map.entry("jdk.jconsole", Set.of("sun.tools.jconsole.inspector", "sun.tools.jconsole")),
            Map.entry("jdk.attach", Set.of("sun.tools.attach")), Map.entry("java.base", Set.of("sun.security.ssl", "sun.reflect.annotation", "sun.reflect.generics.tree", "sun.reflect.generics.scope", "sun.security.validator", "sun.net.ftp", "sun.net.www.protocol.http", "sun.util.logging", "com.sun.net.ssl", "sun.security.provider.certpath", "sun.security.tools", "sun.net.www.content.text", "sun.net.www.protocol.https", "sun.security.provider.certpath.ssl", "sun.invoke", "sun.reflect.generics.parser", "jdk.internal.util.xml.impl", "sun.reflect.generics.reflectiveObjects", "com.sun.security.cert.internal.x509", "sun.net.ftp.impl", "sun.security.provider", "sun.invoke.util", "sun.security.pkcs12", "jdk.internal.org.xml.sax.helpers", "sun.security.pkcs10", "com.sun.crypto.provider", "com.sun.net.ssl.internal.ssl", "sun.net.www.protocol.file", "sun.security.pkcs", "sun.net.smtp", "jdk.internal.org.objectweb.asm.commons", "sun.net.www.protocol.mailto", "sun.security.internal.spec",
             "sun" + ".security" + ".x509", "com.sun" + ".net.ssl.internal.www.protocol.https", "sun.net.sdp", "sun.net.idn", "sun" + ".reflect.generics.factory", "jdk.internal.util.xml", "jdk.internal.org.objectweb.asm.signature", "sun.util", "sun.security.rsa", "sun.util.locale.provider", "sun.invoke.empty", "sun.net.www.protocol.ftp", "sun.security.jca", "sun.util.spi", "sun.security.timestamp", "sun.security.tools.keytool", "sun.security.util", "jdk.internal.org.objectweb.asm.tree.analysis", "sun.security.internal.interfaces", "sun.util.cldr", "sun.net", "sun.util.resources", "sun.nio", "sun.text.normalizer", "sun.launcher", "sun.security.action", "sun.net.www", "jdk.internal.org.xml.sax", "sun.launcher.resources", "jdk.internal.org.objectweb.asm.util", "sun.net.spi", "sun.net.www.http", "sun.net.dns", "sun.text", "sun.util.locale", "sun.nio.fs", "sun.reflect.generics.repository", "sun.text.resources", "sun.net.util", "com.sun.security.ntlm", "sun.net.www.protocol.jar", "sun" +
              ".reflect" + ".generics" + ".visitor", "sun.util" + ".calendar", "sun.io", "sun.net.www.protocol.http.ntlm", "jdk.internal.org.objectweb" + ".asm.tree", "sun.reflect.misc", "sun.nio.ch", "jdk.internal.org.objectweb.asm", "sun.nio.cs", "sun.text.bidi", "com.sun.java.util.jar.pack", "sun.usagetracker")), Map.entry("jdk.crypto.ec", Set.of("sun.security.ec")), Map.entry("jdk.javadoc", Set.of("com.sun.tools.javadoc.resources", "com.sun.tools.doclets.standard")), Map.entry("jdk.management.agent", Set.of("sun.management.jmxremote", "sun.management.jdp")), Map.entry("jdk.crypto.mscapi", Set.of("sun.security.mscapi")), Map.entry("jdk.sctp", Set.of("sun.nio.ch.sctp")), Map.entry("java.sql.rowset", Set.of("com.sun.rowset", "com.sun.rowset.providers", "com.sun.rowset.internal")), Map.entry("java.management", Set.of("com.sun.jmx.remote.internal", "com.sun.jmx.remote.security", "sun.management", "sun.management.counter", "sun.management.counter.perf", "com.sun.jmx.defaults", "com" +
               ".sun.jmx.remote" + ".util", "com" + ".sun.jmx.interceptor", "com.sun.jmx.mbeanserver")), Map.entry("java.smartcardio", Set.of("sun.security" + ".smartcardio")), Map.entry("jdk.scripting.nashorn", Set.of("jdk.nashorn.internal.runtime.regexp", "jdk.nashorn.internal.runtime.regexp.joni.exception", "jdk.nashorn.internal.scripts", "jdk.nashorn.internal.ir.annotations", "jdk.nashorn.internal.codegen.types", "jdk.nashorn.internal.runtime.regexp.joni.encoding", "jdk.nashorn.internal.runtime.events", "jdk.nashorn.internal.runtime.regexp.joni.constants", "jdk.nashorn.internal.runtime.regexp.joni", "jdk.nashorn.tools", "jdk.nashorn.internal.ir", "jdk.nashorn.internal.runtime", "jdk.nashorn.internal.ir.visitor", "jdk.nashorn.internal.runtime.logging", "jdk.nashorn.internal.runtime.linker", "jdk.nashorn.internal.parser", "jdk.nashorn.internal", "jdk.nashorn.internal.runtime.regexp.joni.ast", "jdk.nashorn.internal.ir.debug", "jdk.nashorn.internal.lookup", "jdk.nashorn.internal" +
                ".codegen", "jdk.nashorn" + ".internal" + ".objects", "jdk.nashorn" + ".internal.objects.annotations", "jdk.nashorn.internal.runtime.arrays", "jdk.nashorn" + ".internal.runtime.options")), Map.entry("jdk.internal.jvmstat", Set.of("sun.jvmstat.perfdata.monitor.protocol.local", "sun.jvmstat.perfdata.monitor.v1_0", "sun.jvmstat.monitor.event", "sun.jvmstat.perfdata.monitor.v2_0", "sun.jvmstat.perfdata.monitor", "sun.jvmstat.monitor", "sun.jvmstat.perfdata.monitor.protocol.file")), Map.entry("java.instrument", Set.of("sun.instrument")), Map.entry("java.security.jgss", Set.of("sun.security.jgss.krb5", "sun.security.jgss", "sun.security.krb5.internal.tools", "sun.security.jgss.spi", "sun.security.jgss.wrapper", "sun.security.krb5.internal.rcache", "sun.security.krb5", "sun.security.krb5.internal.crypto", "sun.security.krb5.internal.crypto.dk", "sun.security.jgss.spnego", "sun.security.krb5.internal.ccache", "sun.security.krb5.internal.util", "sun.security.krb5.internal",
                "sun.net.www.protocol.http" + ".spnego", "sun" + ".security.krb5.internal" + ".ktab")), Map.entry("java.scripting", Set.of("com.sun.tools.script.shell")), Map.entry("jdk" + ".jdeps", Set.of("com.sun.tools.classfile", "com.sun.tools.jdeps", "com.sun.tools.jdeps.resources", "com.sun.tools.javap.resources", "com.sun.tools.javap")), Map.entry("jdk.jartool", Set.of("sun.tools.jar.resources", "sun.tools.jar", "sun.security.tools.jarsigner")), Map.entry("java.management.rmi", Set.of("com.sun.jmx.remote.protocol.rmi")), Map.entry("jdk.security.jgss", Set.of("com.sun.security.sasl.gsskerb")), Map.entry("jdk.naming.dns", Set.of("com.sun.jndi.url.dns", "com.sun.jndi.dns")));
    }
